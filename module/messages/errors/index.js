...
exports.getErrorValues = exports.errors = exports.setError = void 0;
const errors = {
    //auth
...
function getErrorValues(errName, prop = undefined) {
    if (errors[errName]) {
        if (prop && typeof errors[errName] === "function") {
            return errors[errName](prop);
        }
        return errors[errName];
    }
    return errors.DEFAULT;
}
exports.getErrorValues = getErrorValues;
...
function setError(errName, prop = undefined) {
